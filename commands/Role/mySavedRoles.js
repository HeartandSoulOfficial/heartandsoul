...
module.exports.run = async (client, message, args, gprefix, level) => {
    ...
    let unable = new MessageEmbed().setDescription("Unable to find your saved roles, or no roles were saved.").setColor('RED')
    ...
    success.addField('Saved Roles', fixRoleMention(message, roleArray))
